...
Cfg.enabled = Cfg.SKILLS_MAP
Cfg.enabled.refund = nil
...
Cfg.group_toggles = {
    ...
    toggle_other      = {'unarmored', 'athletics', 'acrobatics', 'security', 'armorer', 'enchant', 'alchemy', 'sneak', 'speechcraft', 'mercantile'}, --18~27
}
Cfg.custom = {
    toggle_refund = true,
}
